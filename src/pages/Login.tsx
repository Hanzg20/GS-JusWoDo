                    ...
                    <div className="max-w-md mx-auto h-full flex flex-col justify-center">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="pt-6 border-t border-slate-100 space-y-4">
                                ...
                                <div className={showWeChatLogin ? "grid grid-cols-3 gap-3" : "grid grid-cols-2 gap-4"}>
                                    {showWeChatLogin && (
                                        <button
                                            ...
                                            aria-label="WeChat"
                                            title="WeChat"
                                            className="flex items-center justify-center py-4 border-2 border-slate-100 rounded-2xl hover:bg-slate-50 hover:border-slate-200 transition-all disabled:opacity-50"
                                        >
